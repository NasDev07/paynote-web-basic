                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('expenses.insert') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="receipt_image">Upload Receipt/Struk</label>
                                    <input type="file"
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0 mt-2">
                                ...
                                <li>Upload receipt/struk sebagai bukti pengeluaran (opsional)</li>
                                <li>Tanggal tidak boleh lebih dari hari ini</li>
                                <li>Saldo akan otomatis berkurang sesuai jumlah pengeluaran</li>
                            </ul>
                        </div>
